    ...
    render() {
        return (
          <form>
            ...
            defaultValue={!!this.props.eduItem ? this.props.eduItem.institution : ""}
  />
            <br/>
            ...
            <input
             type="date"
             name="start_date"
             defaultValue={!!this.props.eduItem ? this.props.eduItem.start_date: ""}
            ...
            <input
             ...
             defaultValue={!!this.props.eduItem ? this.props.eduItem.certification_type : ""}
             onChange={e => this.props.handleCertificationTypeChange(e)}/>
            <br/>
            <span>Field of Study/Major</span>                                
            <input
             name="field_of_study"
             defaultValue={!!this.props.eduItem ? this.props.eduItem.field_of_study : ""}
             onChange={e => this.props.handleFieldOfStudyChange(e)}/>
            <br/>
            <span>Notable Achievements/Extracurricular</span>                                
            <input
             name="accomplishments"
             defaultValue={!!this.props.eduItem ? this.props.eduItem.accomplishments : ""}
